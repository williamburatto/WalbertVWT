...
with tab_walbert:
    ...
    wb_tab1, wb_tab2, wb_tab3, wb_tab4, wb_tab5, wb_tab6 = st.tabs([
        "🧬 1. Bio-Compósitos & Filamentos 3D (Soja/Milho)",
        "🏭 2. Moldes de Fundição (Casca de Arroz)",
        "🧪 3. Filtros Usinagem CNC (Casca de Arroz)",
        "🛡️ 4. Blindagem EMI, Refratários & Bio-Black",
        "🤝 5. Valoração Rating A VW & Parceria Toyota",
        "💰 6. DRE Estimado & Simulador de ROI Walbert"
    ])
    
    with wb_tab1:
        st.markdown("""
        #### 🧬 Filamentos Poliméricos & Bio-Compósitos para Prototipagem 3D (Indústria 4.0 Verde)
        * **Resíduo de Biomassa Utilizado:** Biocarvão de **Palha de Soja (Planalto Serrano/Campos Novos)** e **Sabugo de Milho (Oeste/Chapecó)** [BDSCv2.csv, RELATORIO_SEMESTRAL_POS_DOUTORADO_28.08.2026_assinado.pdf].
        * **Propriedades Físico-Químicas:** Elevado teor de carbono fixo puro em massa (**58,92%**) [RELATORIO_SEMESTRAL_POS_DOUTORADO_28.08.2026_assinado.pdf], partícula micronizada de alta fluidez (<20 µm) e estabilidade térmica [RELATORIO_SEMESTRAL_POS_DOUTORADO_28.08.2026_assinado.pdf].
        * **Aplicação na Walbert / Inowalbert (Ágora Tech Park):** Extrusão de filamentos compósitos avançados incorporando biochar micronizado em matrizes de ABS, PLA e Nylon para manufatura aditiva (impressão 3D) de gabaritos de controle, berços de montagem e dispositivos [Quem somos! - Walbert Modelação e Ferramentaria.pdf].
        * **Vantagens de Produto:**
          - **Propriedades Antiestáticas:** A condutividade da rede de carbono fixo confere dissipação eletrostática para manuseio seguro de placas eletrônicas e sensores de VEs.
          - **Remoção de Carbono:** Cada kg de biochar de soja/milho incorporado retém **~2,16 kg de CO₂eq** de forma permanente [relatorio-logistica-biocarvao-v2.pdf].
        * **📊 Avaliação Financeira da Linha:**
          - **Investimento Estimado (CAPEX):** R$ 1.500.000,00 (Extrusora industrial, moinho micronizador e laboratório de ensaios).
          - **Faturamento Bruto Anual Estimado:** R$ 6.500.000,00/ano.
          - **Lucro Líquido Anual Estimado:** **R$ 2.800.000,00/ano** (Margem Líquida de ~43,1%).
        """)
        
    with wb_tab2:
        st.markdown("""
        #### 🏭 Moldes & Dispositivos de Fundição Carbon-Negative
        * **Resíduo de Biomassa Utilizado:** Biocarvão de **Casca de Arroz (Região Sul/Turvo e Norte/Massaranduba)** [RELATORIO_SEMESTRAL_POS_DOUTORADO_28.08.2026_assinado.pdf, relatorio-logistica-biocarvao-v2.pdf].
        * **Propriedades Físico-Químicas:** Altíssimo teor de sílica amorfa em cinzas (SiO₂ ~15-20%) e excepcional refratariedade e estabilidade térmica em temperaturas de vazamento de metal líquido (>1.200°C) [RELATORIO_SEMESTRAL_POS_DOUTORADO_28.08.2026_assinado.pdf].
        * **Aplicação na Walbert:** Substituição integral do pó de carvão mineral (fóssil/hulha) por biocarvão de casca de arroz em misturas de areia de fundição sintética para modelos e caixas de macho de alta precisão [Quem somos! - Walbert Modelação e Ferramentaria.pdf].
        * **Vantagens de Produto:**
          - **Acabamento e Isenção de HAP:** Melhora o acabamento superficial das peças fundidas sem defeitos de veios e elimina emissões de Hidrocarbonetos Aromáticos Policíclicos (HAP).
          - **Conformidade Ambiental:** Atende integralmente às exigências da NBR ISO 14001 [Quem somos! - Walbert Modelação e Ferramentaria.pdf].
        * **📊 Avaliação Financeira da Linha:**
          - **Investimento Estimado (CAPEX):** R$ 3.500.000,00 (Misturadores intensivos, silos automáticos e bancada de teste).
          - **Faturamento Bruto Anual Estimado:** R$ 14.000.000,00/ano.
          - **Lucro Líquido Anual Estimado:** **R$ 5.400.000,00/ano** (Margem Líquida de ~38,5%).
        """)
        
    with wb_tab3:
        st.markdown("""
        #### 🧪 Filtros e Meios Filtrantes para Efluentes e Usinagem CNC
        * **Resíduo de Biomassa Utilizado:** Biocarvão Ativado de **Casca de Arroz (Joinville e Vale do Itajaí)** [RELATORIO_SEMESTRAL_POS_DOUTORADO_28.08.2026_assinado.pdf, relatorio-logistica-biocarvao-v2.pdf].
        * **Propriedades Físico-Químicas:** Estrutura mesoporosa ativada com área superficial BET elevada (>800 m²/g) e riqueza em potássio (12.917 mg/kg) [RELATORIO_SEMESTRAL_POS_DOUTORADO_28.08.2026_assinado.pdf].
        * **Aplicação na Walbert:** Regeneração e filtragem fina de fluidos de corte refrigerantes e emulsões sintéticas operadas nos centros de usinagem CNC de 5 eixos de alta precisão da Walbert [Quem somos! - Walbert Modelação e Ferramentaria.pdf].
        * **Vantagens de Produto:**
          - **Economia Operacional Direta:** Prolonga em até 3x a vida útil dos emulsões de usinagem, poupando R$ 600 mil/ano em OPEX próprio de descarte.
          - **Venda Externa de Leitos Filtrantes:** Comercialização dos filtros para usinas de pirólise e indústrias da Região Sul.
        * **📊 Avaliação Financeira da Linha:**
          - **Investimento Estimado (CAPEX):** R$ 1.200.000,00 (Reator de ativação por vapor e colunas de filtragem).
          - **Faturamento Bruto Anual Estimado:** R$ 5.500.000,00/ano.
          - **Lucro Líquido Anual Estimado:** **R$ 2.100.000,00/ano** (Margem Líquida de ~38,1%).
        """)
        
    with wb_tab4:
        st.markdown("""
        #### 🛡️ Blindagem EMI para VEs, Refratários Leves & Pigmentos Bio-Black
        * **Resíduos de Biomassa Utilizados:**
          - **Blindagem EMI (VEs):** Biocarvão de **Palha de Soja (Planalto)** - percolação condutiva para gabinetes de baterias de veículos elétricos.
          - **Placas Refratárias Leves:** Biocarvão de **Sabugo de Milho (Oeste)** - estrutura alveolar para isolamento térmico de matrizes de estamparia a quente.
          - **Pigmento Bio-Black:** Biocarvão de **Palha de Trigo e Feijão (Oeste/Planalto)** - substituição do negro de fumo de petróleo em tintas industriais [BDSCv2.csv, RELATORIO_SEMESTRAL_POS_DOUTORADO_28.08.2026_assinado.pdf].
        * **Aplicação na Walbert:** Desenvolvimento de mantas condutivas contra interferência eletromagnética (EMI Shielding) e pigmento *bio-black* renovável para ferramentais [Quem somos! - Walbert Modelação e Ferramentaria.pdf].
        * **📊 Avaliação Financeira da Linha:**
          - **Investimento Estimado (CAPEX):** R$ 1.800.000,00 (Moinho atritor de alta energia e forno de calcinação).
          - **Faturamento Bruto Anual Estimado:** R$ 8.000.000,00/ano.
          - **Lucro Líquido Anual Estimado:** **R$ 3.200.000,00/ano** (Margem Líquida de ~40,0%).
        """)
        
    with wb_tab5:
        st.markdown("""
        #### 🤝 Valoração Financeira do Rating A (Volkswagen) & Parceria Estratégica Toyota
        * **Sinergia com a Volkswagen do Brasil (S-Rating & SAQ 5.0 / Projeto MQB Hybrid - R$ 16 Bilhões):** O programa *VW Sustainable Chain* exige que fornecedores automotivos adotem soluções de descarbonização [14498-Relatorio-Sustentabilidade-Volkswagen-2024-PT.pdf]. Ao fornecer ferramentais e compósitos *carbon-negative*, a Walbert garante classificação **Rating A (Platinum)** máxima nas auditorias da VW [14498-Relatorio-Sustentabilidade-Volkswagen-2024-PT.pdf].
        * **Sinergia com a Toyota do Brasil (Desafio Ambiental Toyota 2050 / Toyota Supply Chain - R$ 11,5 Bilhões):** Cumpre o pilar de zero emissão no ciclo de vida (*well-to-wheel*), garantindo a nomeação da Walbert em ferramentais das plantas de Sorocaba, Indaiatuba e Porto Feliz [Relatório de Sustentabilidade - Toyota.pdf].
        * **📊 Avaliação Financeira dos Contratos Preferenciais:**
          - **Investimento em Qualificação ESG (CAPEX):** R$ 1.000.000,00 (Adequação ISO 14001, auditorias LCA e certificações S-Rating).
          - **Faturamento Bruto Adicional dos Contratos (VW + Toyota):** R$ 48.000.000,00/ano (R$ 28M/ano VW + R$ 20M/ano Toyota).
          - **Lucro Líquido Adicional Estimado:** **R$ 10.750.000,00/ano** (Margem Líquida de ~22,4%).
        """)

    with wb_tab6:
        st.subheader("💰 DRE Consolidado do Projeto Walbert & Simulador de ROI Interativo")
        st.markdown("""
        Abaixo apresentamos a DRE (Demonstração do Resultado do Exercício) projetada para a implementação completa de todas as linhas tecnológicas de biocarvão na **Walbert Modelação e Ferramentaria** [Quem somos! - Walbert Modelação e Ferramentaria.pdf]:
        """)
        
        # Tabela DRE
        df_dre = pd.DataFrame({
            "Linha de Negócio / Atividade": [
                "1. Filamentos & Bio-Compósitos 3D (Soja/Milho)",
                "2. Moldes de Fundição Carbon-Negative (Arroz)",
                "3. Filtros Usinagem CNC (Arroz Ativado)",
                "4. Blindagem EMI, Refratários & Bio-Black (Milho/Soja)",
                "5. Contratos Preferenciais VW (Rating A) & Toyota",
                "TOTAL CONSOLIDADO PROJETADO"
            ],
            "Biomassa SC Utilizada": [
                "Palha Soja & Sabugo Milho",
                "Casca de Arroz (Sul/Norte)",
                "Casca de Arroz Ativada",
                "Palha Soja/Milho/Trigo",
                "Integração Multibiomassa",
                "Mix Agrícola SC Consolidado"
            ],
            "CAPEX Requerido (R$)": [
                "R$ 1.500.000,00",
                "R$ 3.500.000,00",
            ...
            "Margem Líquida Média": ["43,1%", "38,5%", "38,1%", "40,0%", "22,4%", "29,57%"]
        })
        
        st.dataframe(df_dre, use_container_width=True, hide_index=True)
        
        st.write("---")
        st.markdown("#### 🎛️ Simulador Dinâmico de Escala de Produção e Retorno de Investimento (Walbert)")
        
        cap_pct = st.slider(
            "Selecione o % de Capacidade Instalada Ativa na Planta da Walbert (%):",
            min_value=10, max_value=100, value=100, step=10,
            help="Ajuste a taxa de ocupação da fábrica para calcular dinamicamente o lucro e o tempo de retorno de capital (payback)."
        )
        
        factor = cap_pct / 100.0
        dyn_capex = 10000000.0
        dyn_rev = 82000000.0 * factor
        dyn_profit = 24250000.0 * factor
        dyn_payback_months = (dyn_capex / dyn_profit * 12.0) if dyn_profit > 0 else 999.0
        
        c_r1, c_r2, c_r3, c_r4 = st.columns(4)
        with c_r1:
            st.metric("💰 CAPEX Total da Planta", f"R$ {dyn_capex:,.2f}")
        with c_r2:
            st.metric("📈 Receita Bruta Anual", f"R$ {dyn_rev:,.2f}")
        with c_r3:
            st.metric("🎉 Lucro Líquido Anual", f"R$ {dyn_profit:,.2f}")
        with c_r4:
            st.metric("⏱️ Payback do Investimento", f"{dyn_payback_months:.1f} Meses")
            
        st.success(f"💡 **Parecer Financeiro Walbert:** Com **{cap_pct}%** da capacidade operacional ativa, o Lucro Líquido Anual atinge **R$ {dyn_profit:,.2f}/ano**, retornando o investimento de R$ 10 milhões em apenas **{dyn_payback_months:.1f} meses ({dyn_payback_months/12.0:.2f} anos)**!")
